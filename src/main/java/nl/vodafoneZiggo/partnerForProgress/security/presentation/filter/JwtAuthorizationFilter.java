...
import nl.vodafoneZiggo.partnerForProgress.security.domain.UserProfile;
...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    private Authentication getAuthentication(HttpServletRequest request) {
        ...
        UserProfile principal = new UserProfile((String) parsedToken.getBody().get("emailAddress"));
