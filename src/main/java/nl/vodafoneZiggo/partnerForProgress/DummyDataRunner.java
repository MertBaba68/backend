...
public class DummyDataRunner implements CommandLineRunner {
    ...
    private Category createCategory(String name, String image, List<Service> services) {
        return new Category(name, image, services);
    }

    private Service createService(String name, String description, String image) {
        return new Service(name, description, image);
    }
}